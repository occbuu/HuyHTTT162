...
export class DashboardComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    const dataDailySalesChart: any = {
      ...
      series: [
        [300, 170, 129, 103, 230, 185, 222]
      ]
    };
    const dataDailySalesChart2: any = {
      labels: ['M', 'T', 'W', 'T', 'F', 'S', 'S'],
      series: [
        [120, 17, 70, 80, 100, 160, 250]
      ]
    };
    const dataDailySalesChart3: any = {
      labels: ['M', 'T', 'W', 'T', 'F', 'S', 'S'],
      series: [
        [159, 170, 40, 90, 230, 47, 160]
      ]
    };
    const dataDailySalesChart4: any = {
      labels: ['M', 'T', 'W', 'T', 'F', 'S', 'S'],
      series: [
        [188, 17, 70, 170, 230, 180, 38]
      ]
    };
    ...
    var dailySalesChart3 = new Chartist.Line('#dailySalesChart3', dataDailySalesChart3, optionsDailySalesChart);
    var dailySalesChart4 = new Chartist.Line('#dailySalesChart4', dataDailySalesChart4, optionsDailySalesChart);
